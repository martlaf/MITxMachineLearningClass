...
def run_softmax_on_MNIST(temp_parameter=1):
    ...
    #test_error = compute_test_error_mod3(test_x, np.mod(test_y, 3), theta, temp_parameter)
    return test_error
...
#print("pca error:", test_error_pca)
...
theta, _ = softmax_regression(train_cube, train_y, 1., alpha=0.3, lambda_factor=1.0e-4, k=10, num_iterations=150)
test_error_cube = compute_test_error(test_cube, test_y, theta, 1.)
print("pca10 error:", test_error_cube)